      ...
      >
        ...
        <View style={styles.textOne}>
          <Text style={styles.cxTexto}>
            ...
            {"\n\n"}
            Além de ser um registro formal das ações do aprendiz, a ata permite que o instrutor do
            Senac acompanhe o progresso do aluno no contexto profissional, identifique possíveis
            ...
            aprendiz.
            {"\n\n"}
            O uso da ata reforça a parceria entre o Senac, a empresa e o aprendiz, criando um
