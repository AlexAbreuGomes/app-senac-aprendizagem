...
Ser educado, respeitoso e demonstrar interesse em contribuir para o time ajudará na adaptação e na criação de boas relações com os colegas e supervisores. Com o tempo e esforço, o novo setor pode se tornar um e`,
    icon: require("../assets/icons8-communication-96.png"),
...
Uma dica importante é sempre manter uma comunicação clara e respeitosa. Caso não saiba responder a alguma dúvida, peça ajuda a um colega ou supervisor, em vez de dar informações erradas. Demonstrar paciência e interesse pelo cliente cria um atendimento mais humanizado e melhora a experiência de todos. Com o tempo, desenvolver inteligência emocional no atendimento contribuirá não apenas para o desempenho no trabalho, mas também para o crescimento pessoal e profissional. `,
    icon: require("../assets/icons8-communication-96.png"),
...
Além de usar os EPIs adequadamente, o jovem aprendiz deve manter os equipamentos em bom estado, limpando e armazenando-os corretamente após o uso. Caso algum EPI apresente defeito ou esteja desgastado, é importante informar o supervisor imediatamente para garantir a substituição. A segurança no trabalho é uma responsabilidade de todos, e desenvolver esse hábito desde cedo contribui para uma carreira mais segura e profissional. 
...
Para aqueles que ainda estão no início ou no meio do caminho, inspirem-se nesses exemplos de sucesso. Cada passo dado hoje é um tijolo na construção de uma carreira sólida. Aproveitem cada oportunidade para aprender, mesmo nos momentos mais desafiadores. Lembrem-se: o aprendizado é uma ponte que conecta o presente aos sonhos do futuro.`,
    icon: require("../assets/icons8-communication-96.png"),
    onPress: () => console.log("Resolução de Problemas"),
  },
  {
...
A música não é apenas uma expressão artística; é um convite para que os novos aprendizes se sintam acolhidos e motivados a aproveitar cada momento dessa experiência transformadora. Ao conectar música e aprendizado, Wivilly e João Vitor mostraram que é possível inspirar outros a enxergar o curso não apenas como uma etapa profissional, mas como uma oportunidade de crescimento pessoal.
...
A partir de 1º de janeiro de 2025, o salário mínimo no Brasil foi reajustado para R$ 1.518,00. Com base nesse valor, o salário-hora é de R$ 6,90. O salário deve ser anotado uniformemente na CTPS, no contrato de aprendizagem e na ficha de registro, identificando se o valor é mensal ou por hora. Para jovens aprendizes, a remuneração é calculada de acordo com a carga horária semanal.
...
isso, incluímos trilhas sonoras instrumentais, e outras opções ideais para criar um ambiente calmo e inspirador enquanto você mergulha nos conteúdo do curso, trabalho e vida pessoal.
