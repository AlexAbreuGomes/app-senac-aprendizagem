const quizData = [
  {
    ...
    options: [
      'É um programa voltado para jovens que combina teoria e prática em um ambiente de trabalho.',
      'É uma aprendizagem adquirida apenas dentro do ambiente profissional.',
      'É um curso rápido para qualquer pessoa melhorar suas habilidades técnicas.',
      'É uma modalidade de ensino superior voltada para a formação de especialistas.'
    ],
    correct_option: 'É um programa voltado para jovens que combina teoria e prática em um ambiente de trabalho.'
  },
  {
  ...
  },
  {
    ...
    options: [
      'Sim, o jovem pode ser aprendiz várias vezes na mesma empresa, sem limite de contratos.',
      'Não, o jovem só pode ser aprendiz uma vez, em qualquer empresa.',
  ...
  },
  {
    ...
    options: [
      'Pode ser rescindido antecipadamente se o aprendiz for efetivado na empresa.',
      'Só pode ser encerrado no prazo final, sem exceções.',
      'O contrato pode ser rescindido antecipadamente por desempenho insuficiente, falta disciplinar grave ou pedido do aprendiz.',
      'Pode ser rescindido a qualquer momento, sem necessidade de justificativa.'
    ],
    correct_option: 'O contrato pode ser rescindido antecipadamente por desempenho insuficiente, falta disciplinar grave ou pedido do aprendiz.'
  },
  {
  ...
  },
  {
    ...
    correct_option: 'Sim. O aprendiz, maior de 18 anos, que cumpra jornada em horário noturno faz jus ao recebimento do respectivo adicional.'
  }
];
